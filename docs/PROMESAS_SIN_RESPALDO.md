...
| A2 | **Plan semanal de cinco almuerzos** | semanas. Es un producto nuevo entero: días, horarios, elegir el sándwich cada noche, envío incluido en el precio, y recostearlo desde cero | ~3 horas: la pantalla pasa a contar lo que es — **pagas S/95 y tienes S/100 para gastar** | **decir la verdad ahora, construir después de abrir.** Cinco almuerzos programados es un producto que ni siquiera está costeado |
...
| A4 | **El pedido fijo se manda solo** | no se construye: **ya se decidió lo contrario a propósito** y hay una prueba que lo protege | ~30 minutos | **decir la verdad, sin discusión.** La maqueta reintrodujo una promesa que el repo ya había retirado por buenas razones |
