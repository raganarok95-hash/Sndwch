...
export const CARTA: Carta = {
  ...
  signatures: [
    ...
    { id: "SIG10", nombre: "Turkey", tipo: "Signature", orden: 3, pan: "B01", prot: "P08", vegetales: ["T09", "T01", "T03", "T06"], salsas: ["S06"], p15: 23.9, p30: 34.9,
      pitch: "Pavo horneado en lonjas finas, con lechuga, tomate, cebolla y pimiento, terminado con aceite y vinagre." },
    { id: "SIG12", nombre: "Tuna Melt", tipo: "Signature", orden: 4, pan: "B01", prot: "P04", vegetales: [], salsas: [], p15: 22.9, p30: 36.9, queso: "C02",
