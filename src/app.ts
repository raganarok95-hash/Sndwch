...
async function doReg(){
  ...
  try{
    ...
    var r=await api('register',{name:name,phone:phone,pin:pin,email:email||null,dni:dni,bday:bday,referredBy:referredBy||null,claimOrderRef:claimRef,acquisitionSource:acqSrc});
