...
var SIG_IMG={SIG01:'img/sig01.jpg',SIG02:'img/sig02.jpg',SIG03:'img/sig03.jpg',SIG04:'img/sig04.jpg',SIG07:'img/sig07.jpg'};
...
function sOHome(){
  ...
  return H()
    ...
    +'<div style="font-family:Barlow Condensed,sans-serif;font-size:27px;font-weight:900;color:#fff;margin-bottom:8px;text-wrap:balance">SIGNATURE<span style="color:'+GOLD+'"> // </span>BUILDS</div>'
    ...
    +(manualWaiting?'<div style="margin-top:10px">'
      +(receiptUploadState==='done'
        ...
        :'<label style="display:inline-flex;align-items:center;gap:6px;cursor:'+(receiptUploadState==='uploading'?'default':'pointer')+';font-family:\'Share Tech Mono\',monospace;font-size:9px;color:'+GOLD+';text-decoration:underline;letter-spacing:.05em">'
          +(receiptUploadState==='uploading'?'subiendo comprobante...':'📎 subir captura del comprobante (opcional)')
