...
function sOHome(){
  ...
  return H()
    ...
    +cartCard
    +recoCard
    +'<div style="font-family:EB Garamond,serif;font-weight:600;font-size:9px;color:var(--sw-text-body,#F2F0EB);opacity:.8;letter-spacing:.15em;margin-bottom:20px">¿Cómo quieres pedir? //</div>'
