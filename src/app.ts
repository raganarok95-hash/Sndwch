    ...
    +(function(){
      ...
      var vaultCard=secretSig?(function(){
        ...
        return'<div style="margin:20px 0 16px"><div style="font-family:\'EB Garamond\',serif;font-weight:600;font-size:9px;color:'+GOLD+';letter-spacing:.2em;margin-bottom:10px">Menú secreto //</div>'
          +'<div onclick="'+(unlocked?'startOrderWithSig(\''+secretSig.id+'\')':'')+'" style="background:linear-gradient(160deg,#1A3028,#0d1a15);border:1px dashed rgba(203,162,88,.4);border-radius:14px;padding:22px 20px;text-align:center;'+(unlocked?'cursor:pointer':'')+'">'
          +'<span style="display:inline-block;font-family:\'EB Garamond\',serif;font-weight:600;font-size:8px;color:'+GOLD+';letter-spacing:.2em;border:1px solid '+GOLD+';border-radius:4px;padding:3px 10px;margin-bottom:12px">Secreto</span>'
