...
function sOHome(){
  ...
  return H()
    ...
    +(function(){
      ...
      return'<div style="font-family:Bodoni Moda,serif;font-optical-sizing:auto;font-size:22px;font-weight:640;color:#fff;margin-bottom:8px;line-height:1.15;text-wrap:balance">SIGNATURE<span class="cut-sep" style="color:'+GOLD+'"> // </span>BUILDS</div>'
    ...
    +'<div style="font-family:Bodoni Moda,serif;font-optical-sizing:auto;font-size:22px;font-weight:640;color:#fff;margin-bottom:8px;line-height:1.15;text-wrap:balance">ARMA<span class="cut-sep" style="color:'+GOLD+'"> // </span>EL TUYO</div>'
...
function sAdminHome(){
  ...
  return'<div style="min-height:100vh;display:flex;flex-direction:column;background:var(--sw-bg,#1E3932)">'
    ...
    +'<div><div style="font-family:\'Bodoni Moda\',serif;font-optical-sizing:auto;font-size:16px;font-weight:640;color:#F5C518;text-wrap:balance">PANEL<span style="color:#fff"> // </span>DE NEGOCIO</div><div style="font-family:\'EB Garamond\',serif;font-weight:600;font-size:9px;color:#a08010;letter-spacing:.1em;margin-top:2px">ventas · productos top · clientes · puntos</div></div>'
...
function cpRow(label,inputsHtml,fn){
  return'<div class="cp-row" data-name="'+esc(label.toLowerCase())+'" style="background:var(--sw-card,#2D5246);border:1px solid var(--sw-border,#3A6B58);border-radius:10px;padding:14px 16px;margin-bottom:10px">'
    ...
    +'<button onclick="'+fn+'" style="all:unset;cursor:pointer;background:'+GOLD+';color:#fff;font-family:\'Bodoni Moda\',serif;font-optical-sizing:auto;font-size:12px;font-weight:600;padding:9px 14px;border-radius:8px;white-space:nowrap">GUARDAR</button></div></div>';
}
