...
var PROTS:{id:string;l:string;s:string;d:string;p15:number;p30:number;pDbl:number;pDbl30:number;vaultOnly?:boolean;sigOnly?:boolean;noDouble?:boolean;noDouble30?:boolean}[]=[
  ...
  // P01 (res mechada) y P02 (pollo teriyaki) salieron con la carta v4 (2026-09-24): ya no se
  // preparan. Se retiraron enteras, como el apio: marcarlas `sigOnly` sin ningún Signature que
  // las use las dejaba imposibles de pedir y vivas como insumo. Los pedidos viejos conservan
  // su resumen. P05 sigue, solo para el Italian Hoagie.
  ...
  // frío y salteada al momento en sartén grande —no hay plancha— (no el corte exclusivo P07 que se retiró con THE CHICAGO).
  // Porción 85 g a S/20/kg con rendimiento 0.70 = S/2.43 (supuesto: medirlo en la primera
  // tanda). El precio es el que deja el armado en el techo de 45%, calculado con
  // modelo/rentabilidad_por_parte.py como el del pavo: 44.8% en los dos tamaños. El doble
  // (7 / 13) es el de la v4. DEBE coincidir con PROT_PRICE.P09 en catalog.ts.
  {id:'P09',l:'Res',    s:'Laminada',   d:'Laminada fina y salteada al momento.',p15:12.9,p30:22.9,pDbl:7,pDbl30:13}
...
var TOPS:{id:string;l:string;s:string;d?:string;vaultOnly?:boolean;sigOnly?:boolean;spicy?:boolean}[]=[
  ...
  // T02 (pepinillo) retirado con la carta v4 (2026-09-24): ya ningún Signature lo lleva.
  ...
  // T10 entra con el Philly (2026-09-24): cebolla BLANCA salteada, que no es la T03 (morada,
  // cruda, en juliana). Solo para Signatures, como el pepinillo. DEBE coincidir con
  // TOP_LABEL/SIG_ONLY_TOPS en catalog.ts.
  {id:'T10',l:'Cebolla',  s:'Salteada',d:'Blanca, salteada junto con la res.',sigOnly:true}
];
...
var SIGS:any[]=[
  // LA CARTA v4, LOS CLÁSICOS DE USA (decisión del dueño, 2026-09-24). Reemplaza entera a la de
  // apertura: salen The Original (SIG01), The Smoke (SIG03) y The Teriyaki (SIG06), que quedan
  // retirados en `catalog_items` (active=false) con su receta guardada. Costeo, precios y por qué
  // en docs/MENU_CLASICOS_USA.md (v4) y modelo/menu_clasicos_usa.py; el relato en DECISIONES.
  //
  // SEMILLA: el primer render y el respaldo si la base no responde. La carta real es la de
  // `catalog_items` y se edita desde el panel. Sin badges (decisión del dueño). Los textos de
  // Philly y Turkey siguen cómo los describen las cadenas grandes: por ingredientes, sin adorno.
  //
  // `recommended` NO vive en `catalog_items`: este literal es la fuente real de la estrella. Va
  // en el que más deja en soles a 15CM (regla del 2026-09-12, ver SIG_DISPLAY_ORDER en 03-*):
  // con la v4 es el Philly (S/17.48 contra S/17.43 del Meatball). Lo fija estrella-del-menu.spec.
  {id:'SIG09',n:'Philly Cheesesteak',s:'Signature',badge:'',recommended:true,base:'B01',prot:'P09',tops:['T10','T06'],sauces:[],p15:22.9,p30:32.9,fixedCheese:'C02',
    pitch:'Res laminada fina, salteada al momento con cebolla y pimiento, y cheddar fundido encima. Sin salsa: no le hace falta.'},
  {id:'SIG02',n:'Meatball Marinara',s:'Signature',badge:'',base:'B01',prot:'P06',tops:['T01','T03','T05'],sauces:['S06'],p15:21.9,p30:28.9,fixedCheese:'C01',
  ...
  // Sin tocino (v4) y con Oil & Vinegar: el «Mike's Way» de Jersey Mike's, no aioli.
  {id:'SIG10',n:'Turkey',s:'Signature',badge:'',base:'B01',prot:'P08',tops:['T09','T01','T03','T06'],sauces:['S06'],p15:23.9,p30:34.9,
    pitch:'Pavo horneado en lonjas finas, con lechuga, tomate, cebolla y pimiento, terminado con aceite y vinagre.'},
  {id:'SIG12',n:'Tuna Melt',s:'Signature',badge:'',base:'B01',prot:'P04',tops:[],sauces:[],p15:22.9,p30:36.9,fixedCheese:'C02',
  ...
  {id:'SIG11',n:'Italian Hoagie',s:'Signature',badge:'',base:'B01',prot:'P05',tops:['T09','T01','T03','T06'],sauces:['S06'],p15:23.9,p30:33.9,fixedCheese:'C01',
  ...
  // Atún escurrido, mayonesa y pimienta, nada más: la mayonesa está dentro de P04 y la pimienta
  // es parte de su preparación (RECETARIO.md), por eso `tops` y `sauces` van vacíos.
  {id:'SIG04',n:'Classic Tuna',s:'Signature',badge:'',base:'B01',prot:'P04',tops:[],sauces:[],p15:20.9,p30:34.9,
...
var SIG_IMG={SIG02:'img/sig02.jpg',SIG04:'img/sig04.jpg',SIG05:'img/sig05.jpg',SIG09:'img/sig09.jpg',SIG11:'img/sig11.jpg'};
...
var PROT_IMG={P04:'img/prot_p04.webp',P05:'img/prot_p05.webp',P06:'img/prot_p06.webp',P08:'img/prot_p08.webp'};
